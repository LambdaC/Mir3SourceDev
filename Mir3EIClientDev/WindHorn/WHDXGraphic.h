...
///////<---------------------------------------------------------------------------------------------------------------------------
	...
	/* 控制游戏窗口是全屏模式还是窗口模式, 选项见WHEngine::_DXG_SCREENMODE_XXX */
	BYTE					m_bScreenModeFlag;
	/* 控制设备使用什么选项? 见WHEngine::_DXG_DEVICEMODE_XXX */
...
public:
    ...
    RECT					m_rcWindow;
	DXG_DISPLAYINFO			m_stDisplayInfo;	// Display数据，长宽及位深
	DXG_MASKINFO			m_stBitsMaskInfo;

	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// 프로세스를 나누기위한 변수선언.
	// Declaration of variables to divide the process.
	// 声明变量以划分过程。
